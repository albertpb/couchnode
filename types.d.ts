...
export declare type CreateDataverseCallback = (
  err: Error,
  success: boolean
) => void;

export declare type DropDataverseCallback = (
  err: Error,
  success: boolean
) => void;

export declare type CreateDatasetCallback = (
  err: Error,
  success: boolean
) => void;

export declare type DropDatasetCallback = (
  err: Error,
  success: boolean
) => void;
...
export declare type GetAllDatasetsCallback = (
  err: Error,
  datasets: AnalyticsDataset[]
) => void;

export declare type CreateAnalyticsIndexCallback = (
  err: Error,
  success: boolean
) => void;

export declare type DropAnalyticsIndexCallback = (
  err: Error,
  success: boolean
) => void;
...
export declare type ConnectLinkCallback = (
  err: Error,
  success: boolean
) => void;

export declare type DisconnectLinkCallback = (
  err: Error,
  success: boolean
) => void;
...
export declare type IncrementCallback = (
  err: Error,
  res: IncrementResult
) => void;
...
export declare type DecrementCallback = (
  err: Error,
  res: DecrementResult
) => void;
...
export declare type ViewQueryCallback = (
  err: Error,
  res: ViewQueryResult
) => void;
...
export declare type GetBucketCallback = (
  err: Error,
  res: BucketSettings
) => void;

export declare type GetAllBucketsCallback = (
  err: Error,
  res: BucketSettings[]
) => void;
...
export declare type DiagnosticsCallback = (
  err: Error,
...
export declare type AnalyticsQueryCallback = (
  err: Error,
  res: AnalyticsResult
) => void;
...
export declare type SearchQueryCallback = (
  err: Error,
...
export declare type GetAnyReplicaCallback = (
  err: Error,
  res: GetReplicaResult
) => void;

export declare type GetAllReplicasCallback = (
  err: Error,
  res: GetReplicaResult[]
) => void;
...
export declare type GetAndTouchCallback = (
  err: Error,
...
export declare type GetAndLockCallback = (
  err: Error,
...
export declare type LookupInCallback = (
  err: Error,
  res: LookupInResult
) => void;
...
export declare type MutateInCallback = (
  err: Error,
  res: MutateInResult
) => void;
...
export declare type CreateCollectionCallback = (
  err: Error,
  res: boolean
) => void;
...
export declare module 'couchbase' {
  /**
...
export declare type CreateQueryIndexCallback = (
  err: Error,
  res: boolean
) => void;

export declare type CreatePrimaryIndexCallback = (
  err: Error,
  res: boolean
) => void;
...
export declare type DropPrimaryIndexCallback = (
  err: Error,
  res: boolean
) => void;

export declare type GetAllQueryIndexesCallback = (
  err: Error,
  res: QueryIndex[]
) => void;

export declare type BuildDeferredIndexesCallback = (
  err: Error,
  res: string[]
) => void;
...
export declare type GetSearchIndexCallback = (
  err: Error,
  res: SearchIndex
) => void;

export declare type GetAllSearchIndexesCallback = (
  err: Error,
  res: SearchIndex[]
) => void;

export declare type UpsertSearchIndexCallback = (
  err: Error,
  res: boolean
) => void;

export declare type DropSearchIndexCallback = (
  err: Error,
  res: boolean
) => void;

export declare type GetIndexedDocumentsCountCallback = (
  err: Error,
  res: number
) => void;
...
export declare type DisallowQueryingCallback = (
  err: Error,
  res: boolean
) => void;
...
export declare type AnalyzeDocumentCallback = (
  err: Error,
  res: object[]
) => void;
...
export declare type GetRolesCallback = (
  err: Error,
  res: RoleAndDescription[]
) => void;
...
export declare type GetAllDesignDocumentsCallback = (
  err: Error,
  res: DesignDocument[]
) => void;

export declare type GetDesignDocumentCallback = (
  err: Error,
  res: DesignDocument
) => void;

export declare type UpsertDesignDocumentCallback = (
  err: Error,
  res: boolean
) => void;

export declare type DropDesignDocumentCallback = (
  err: Error,
  res: boolean
) => void;

export declare type PublishDesignDocumentCallback = (
  err: Error,
  res: boolean
) => void;
